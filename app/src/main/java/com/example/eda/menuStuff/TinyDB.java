...
public class TinyDB {
    ...
    public ArrayList<GridViewDomain> getListObject(String key){
        Gson gson = new Gson();

        ArrayList<String> objStrings = getListString(key);
        ArrayList<GridViewDomain> playerList =  new ArrayList<GridViewDomain>();

        for(String jObjString : objStrings){
            GridViewDomain player  = gson.fromJson(jObjString,  GridViewDomain.class);
    ...
    public void putListObject(String key, ArrayList<GridViewDomain> playerList){
        checkForNullKey(key);
        Gson gson = new Gson();
        ArrayList<String> objStrings = new ArrayList<String>();
        for(GridViewDomain player: playerList){
